(function () {
    ...
    document.getElementById('toggle-cam').addEventListener('click', () => {
        const videoTrack = userMediaStream.getTracks().find(track => track.kind === 'video');
        if (videoTrack.enabled) {
            videoTrack.enabled = false;
           
            
            document.getElementById('toggle-cam').innerHTML = 'Show cam'
        } else {
            videoTrack.enabled = true;
            
            document.getElementById('toggle-cam').innerHTML = "Hide cam"
        }
    });
  
    document.getElementById('toggle-audio').addEventListener('click', () => {
      const audioTrack = userMediaStream.getTracks().find(track => track.kind === 'audio');
      if (audioTrack.enabled) {
        audioTrack.enabled = false;
        
        document.getElementById('toggle-audio').innerHTML = 'Unmute'
      } else {
        audioTrack.enabled = true;
        document.getElementById('toggle-audio').innerHTML = "Mute"
      }
    });
